...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-bkg-1 text-neutral-content border-b border-zinc-600 bg-opacity-66">
          ...
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Link href="/" target="_blank" rel="noopener noreferrer" passHref className="text-secondary hover:text-white">
                ...
                <img
                  src="/solanaLogo.png"
                  alt="PoolParty"
                  style={{ height: '4rem', padding: '0.5rem', borderRadius: '0.5rem' }}
                />
